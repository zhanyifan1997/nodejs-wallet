...
<html lang="en">
<head>
    <title>Code coverage report for ethereumjs-tx/fake.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">ethereumjs-tx/</a> fake.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (data &amp;&amp; data.from) {
      this.from = data.from
    }
  }
&nbsp;
